...
export function summary() {
  return {
    ...
    recommendation:
      "Block privileged auto-approvals, self-reviews, and stale application gaps before the next identity-governance closeout window."
  };
}
...
export function verification() {
  return [
    "Privileged role template ids are explicitly tracked so recruiter-visible Microsoft admin posture is concrete, not generic.",
    "The dashboard is backed by a real offline analyzer and CLI, not static text alone.",
    "Synthetic sample data only; no tenant identifiers, tokens, or live Graph exports are committed.",
    "Review-lane, risk, and remediation views stay buyer-readable for Entra, Microsoft 365, and audit stakeholders.",
