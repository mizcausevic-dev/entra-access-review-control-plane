...
import {
  ...
  summary,
  verification
} from "./services/entraAccessReviewControlPlaneService.js";

describe("entra-access-review-control-plane dashboard services", () => {
  test("returns a recruiter-readable governance recommendation", () => {
    expect(summary().recommendation).toMatch(/privileged/i);
  });
