...
function New-ProofImage {
    ...
    $graphics.DrawString("Entra Access Review Control Plane", $eyebrowFont, $accentBrush, 92, 92)
...
New-ProofImage -Path (Join-Path $screenshots "01-overview-proof.png") `
    ...
    -Subtitle "Privileged-role reviews, stale decisions, and remediation posture in one Entra operator surface." `
    -Bullets @(
...
New-ProofImage -Path (Join-Path $screenshots "03-access-risks-proof.png") `
    ...
    -Bullets @(
        ...
        "The lane is grounded in Microsoft Graph review exports."
    )
